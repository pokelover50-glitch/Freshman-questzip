...
function FullscreenButton() {
  ...
  return (
    <button
      ...
      className="fixed top-4 right-4 z-50 w-8 h-8 flex items-center justify-center rounded-md bg-card/80 border border-border hover:border-fuchsia-500/50 hover:bg-fuchsia-950/40 transition-all duration-200 text-muted-foreground hover:text-fuchsia-300 shadow-md backdrop-blur-sm"
    >
      {isFs ? (
